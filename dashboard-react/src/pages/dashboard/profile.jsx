        ...
        <CardBody className='p-4'>
          <div className='mb-10 flex items-center justify-between flex-wrap gap-6'>
            <div className='flex items-center gap-6'>
              <Avatar src='/img/bruce-mars.jpeg' alt='bruce-mars' size='xl' variant='rounded' className='rounded-lg shadow-lg shadow-blue-gray-500/40' />
              <div>
            ...
            <div>
              ...
              <div className='flex flex-col gap-12'>
                {platformSettingsData.map(({ title, options }) => (
                  <div key={title}>
                    <Typography className='mb-4 block text-xs font-semibold uppercase text-blue-gray-500'>{title}</Typography>
