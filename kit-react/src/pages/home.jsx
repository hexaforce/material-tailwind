...
import { Card, CardBody, CardHeader, Typography, Button, IconButton, Input, Textarea, Checkbox } from '@material-tailwind/react'
            ...
            <div className='mx-auto mt-24 flex w-full justify-center px-4 md:w-4/12 lg:mt-0'>
              <Card className='shadow-lg border shadow-gray-500/10 rounded-lg'>
                ...
                <CardBody>
                  ...
                  <Typography className='font-normal text-blue-gray-500'>The Arctic Ocean freezes every winter and much of the sea-ice then thaws every summer, and that process will continue whatever happens.</Typography>
                </CardBody>
              </Card>
            </div>
          </div>
